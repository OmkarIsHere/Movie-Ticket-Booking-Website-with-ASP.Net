...
namespace Registration
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                String conn = "Data Source=LAPTOP-25OBO32L\\SQLEXPRESS;Initial Catalog=CinemaTicketBooking;Integrated Security=True";
                String q = ("select Email from Registration where Email='" + TextBox2.Text + "' and Status = 'verified' ");
                ...
                else
                {
                    try
                    {
                        ...
                        String con = "Data Source=LAPTOP-25OBO32L\\SQLEXPRESS;Initial Catalog=CinemaTicketBooking;Integrated Security=True";
                        String query = "insert into Registration (Username, Email, Password, Confirm_Password, Status, Code) values('" + TextBox1.Text + "', '" + TextBox2.Text + "' , '" + TextBox3.Text + "' , '" + TextBox4.Text + "',  'unverified',  '" + code + "' )";
