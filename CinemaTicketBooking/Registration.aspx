        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tr class="tr">
                    ...
                    <td class="td"> <asp:TextBox ID="TextBox2" runat="server" TextMode="Email" TabIndex="2" CssClass="inputemail"></asp:TextBox><asp:RequiredFieldValidator runat="server" ErrorMessage="This Field is required" ControlToValidate="TextBox2" CssClass="rf2"></asp:RequiredFieldValidator></td>
                </tr>
                <tr class="tr">
                    <td class="td"><asp:Label ID="Label4" runat="server" Text="Password :" CssClass="password1"></asp:Label></td>
                    <td class="td"> <asp:TextBox ID="TextBox3" runat="server"  TabIndex="3" CssClass="inputpassword"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="This field is required" ControlToValidate="TextBox3" CssClass="rf3"></asp:RequiredFieldValidator></td>
                </tr>
                <tr class="tr">
                    <td class="td"><asp:Label ID="Label5" runat="server" Text="Confirm Password :" CssClass="password2"></asp:Label></td>
                    <td class="td"> <asp:TextBox ID="TextBox4" runat="server" TextMode="Password" ToolTip="Type same password as above" TabIndex="4" CssClass="inputpassword2"></asp:TextBox><asp:RequiredFieldValidator runat="server" ErrorMessage="This field is required" ControlToValidate="TextBox4" CssClass="rf4"></asp:RequiredFieldValidator></td> 
                </tr>
            </table>
            ...
            <asp:Label ID="Label6" runat="server" Text="Already have an account?" CssClass="lastline"></asp:Label><asp:HyperLink ID="HyperLink1" runat="server" CssClass="hyperlink">Login</asp:HyperLink>
        </div>
    </section>
